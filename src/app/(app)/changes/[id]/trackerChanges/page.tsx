            ...
            <div className="min-w-0">
              <div className="flex flex-wrap items-center gap-3">
                <h1 className="text-2xl font-bold tracking-tight text-[var(--text)] sm:text-3xl">
                  {firstChange?.company_name}
                </h1>

                <span
                  className={`inline-flex rounded-full px-2.5 py-1 text-xs font-medium ${getStatusClass(
                    firstChange?.status?.toLowerCase() || ""
                  )}`}
                >
                  {firstChange?.status}
                </span>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-[var(--text)]">
                {formatDate(firstChange?.created_at)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--card)] p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-[var(--text)]">
                {formatDate(firstChange?.detected_at)}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="rounded-[var(--radius-lg)] border border-[var(--border)] bg-[var(--card)] p-5 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm font-semibold text-[var(--text)]">
                {formatDate(firstChange?.updated_at)}
              </p>
            </div>
          </div>
        </div>
